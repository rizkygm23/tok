    ...
    return (
        <div className='w-full h-full'>
            ...
            viewport={{once:true, amount:0.1}}
             ...
             className='w-full h-fit py-1  sticky top-0 bg-[#374957] z-50'>
            ...
            <div className='w-full h-fit  grid grid-cols-1 md:grid-cols-2 mt-20 px-5 md:px-24 lg:px-52'>
                <div className='item-center w-full h-fit py-10 my-auto px-4'>
                    ...
                    whileInView={"show"}
                    viewport={{once:true, amount:0.1}}
                    className='text-sm md:text-lg bg-[#374957] hover:bg-slate-900 text-white px-4 hover:pr-6 py-2 mt-4 rounded'>See more</motion.button>
                </div>
                <motion.div 
                variants={fadeIn("up", 0.3)}
                initial={"hidden"}
            ...
            <div id='bigsale'>
                ...
                {inventory.slice(0, 3).map((item,index) => <CardBigSale key={item.id} id={item.id} nama={item.name} price={item.price} image_url={item.image_url} delay={delay * index} index={index} /> ) }
                </div>                            
            </div>
            ...
            <div id='bestseller'>
                ...
                <div className='w-full h-fit grid grid-cols-1 md:grid-cols-2 gap-4'>
                    <motion.div
                        ...
                        <button onClick={() => router.push(`/detail/?id=${item.id}`)} className='bg-[#374957] hover:bg-slate-900 text-white px-8   py-4 mt-4 rounded'>Buy now</button>
                    ...
                    <motion.div
                        ...
                        whileInView={"show"}
                        viewport={{once:true, amount:0.1}}
                        className='w-full h-full p-2 md:p-5 lg:p-11'>
            ...
            id="preview" className="relative w-full h-full p-5 md:p-52">
                <img
                    src="preview.png"
